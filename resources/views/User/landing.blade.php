...
@section('title', 'NGADU - Pengaduan Masyarakat')
...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">NGADU</h4>
    ...
    <div class="text-center">
        ...
        <p class="italic text-white mb-5">Dengan Ngadu jadikan Indonesia lebih Maju</p>       
    </div>
